      ...
      rec.onstop = async () => {
        ...
        try {
          ...
          setData(prev => {
            ...
            mechanics.pneus = computePneus(
              mechanics.pneusAvant,
              mechanics.pneusArriere
            );
              ...
              <div className="meca-grid">
                ...
                {Object.entries(mechanicsLabels).map(([k, label]) => (
                  <div key={k} className="meca-row">
                    <span className="meca-label">
                      {label}
                    </span>

                    <span
                      className={
                        data.mechanics[k] === 'OUI'
                          ? 'badge-oui'
                          : 'badge-non'
                      }
                      onClick={() =>
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() =>
                        setData(prev => {
                          const pneusArriere =
                            prev.mechanics.pneusArriere === 'OUI'
                              ? 'NON'
                              : 'OUI';

                          const pneus =
                            computePneus(
                              prev.mechanics.pneusAvant,
                              pneusArriere
                            );
